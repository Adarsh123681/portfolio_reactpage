...
function About() {
  ...
  return (
    <>
      {/* main */}
      <div
        className="h-screen mb-20 text-center p-2 bg-gray-800"
      >
 <h1 className="text-2xl py-4 md:text-xl m-2 p-2 bg-gray-600 text-cyan-300 rounded-lg font-bold text-center tracking-wide">About Me</h1>
        ...
        />
        {/* cotntent */}
        <div className=" h-fill w-3/5 text-sm md:my-4 md:text-xl text-lime-50 tracking-wider break-words m-auto">
