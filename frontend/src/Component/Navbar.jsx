...
function Navbar() {
   ...
   return (
      <>
         <div className=" h-16 bg-gray-700 font-medium transition-all duration-500 transition-all overflow-hidden">
            {/* lOGO */}
            <div className="flex">
            ...
            </div>
            {
               open && (<ul className="w-full h-[20rem] flex flex-col absolute right-0 bg-gray-700 text-white pl-8 text-md font-mono transition-all duration-300">
                  ...
                  <Link to="/services"><input type="button" className='mx-2 lg:mx-5 hover:text-red-500 transition-all duration-200 tracking-wide font-bold font-mono'/>Services</Link>
