...
function Footer() {
    return (
        <>
            <footer className="bg-gray-800 sshadow dark:bg-gray-900 -mt-1 py-10">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <a href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                            <img src="./image/Adarsh.jpeg" className="h-8" alt='name'/>
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ADARSH TRIPTHI PORTFOLIO</span>
                        </a>
                        <ul className="flex flex-wrap items-center mb-6 text-xl sm:text-xl font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
